package com.family.application.views.answers;

import com.family.application.data.SampleAddress;
import com.family.application.services.SampleAddressService;
import com.family.application.views.MainLayout;
...
@PageTitle("Answers")
@Route(value = "answers/:sampleAddressID?/:action?(edit)", layout = MainLayout.class)
@AnonymousAllowed
public class AnswersView extends Div implements BeforeEnterObserver {

    private final String SAMPLEADDRESS_ID = "sampleAddressID";
    private final String SAMPLEADDRESS_EDIT_ROUTE_TEMPLATE = "answers/%s/edit";
    ...
    public AnswersView(SampleAddressService sampleAddressService) {
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(AnswersView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (sampleAddressId.isPresent()) {
            ...
            if (sampleAddressFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(AnswersView.class);
            }
        }
    }
